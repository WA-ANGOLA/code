...
SOLA Web Admin uses 5 Git repositories for managing its code base. These
repositories are:
...
1) code      - This repository. Contains the Main POM file and
               ...
               Git repositories. 
2) clients   - Contains client Web Admin project
...
4) messaging - Contains only the Common Messaging project. Attached as
